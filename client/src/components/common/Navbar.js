      ...
      <header>
        <div className="nav-bar py-1 bg-white border-bottom">
          <div className="container d-flex justify-content-center align-items-center text-center">
            ...
            {/* Right elements */}
            <div className="col-md col-sm text-end">
              <Link to="/account" className="m-2 menu-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" className="bi bi-person" viewBox="0 0 16 16">
              ...
              <Link to="/basket" className="m-2 menu-item">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" className="bi bi-cart" viewBox="0 0 16 16">
